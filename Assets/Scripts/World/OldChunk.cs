...
//
//	void Start () {
//        blocks = new BlockData[CHUNK_WIDTH, CHUNK_HEIGHT, CHUNK_WIDTH];
//
...
//    void PlaceBlock(BlockData block, int x, int y, int z) {
////		if(block.GetComponent<Block>() != null) {
//		if(blocks[x,y,z] == null) {
//            blocks[x,y,z] = ((GameObject)Instantiate(block.gameObject, transform.InverseTransformPoint(new Vector3(x, y, z)), Quaternion.identity, transform)).GetComponent<BlockData>();
//		} else {
...
//    BlockData[] GetNeighbors(int x, int y, int z) {
