...
namespace System.Buffers
{
    internal sealed partial class DefaultArrayPool<T> : ArrayPool<T>
    {
        ...
        internal DefaultArrayPool(int maxArrayLength, int maxArraysPerBucket)
        {
            if (maxArrayLength <= 0)
            {
                UnityEngine.Debug.LogError("ArrayPool constructor error: maxArrayLength <= 0!");
                //throw new ArgumentOutOfRangeException(nameof(maxArrayLength));
            }
            if (maxArraysPerBucket <= 0)
            {
                UnityEngine.Debug.LogError("ArrayPool constructor error: maxArraysPerBucket <= 0!");
            ...
            {
                buckets[i] = new Bucket(4, maxArraysPerBucket, poolId);
            }
            _buckets = buckets;
        }
        ...
        public override T[] Rent(int minimumLength)
        {
            ...
            if (minimumLength < 0)
            {
                UnityEngine.Debug.LogError("ArrayPool rent error: minimum length can't be less than zero!");
            ...
            {
                UnityEngine.Debug.LogError("Requested size too large for pool. Allocating a temp array.");
        ...
        public override void Return(T[] array, bool clearArray = false)
        {
            if (array == null)
            {
                UnityEngine.Debug.LogError("ArrayPool return error: array is null!");
